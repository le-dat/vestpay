...
import {
  ...
  searchTokens,
  sortTokens,
} from "@/integrations/dex/suilend/tokens";
      ...
      >
        {selectedToken ? (
          <>
            ...
            <span className="font-black text-[18px] text-[#111827] dark:text-white">
        ...
        <svg
          className="w-5 h-5 text-[#94a3b8] group-hover:text-[#111827] transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
