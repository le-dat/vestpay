              ...
              >
                ...
                <td className="py-4 text-right">
                  <div className="text-gray-900 font-medium">
                    {pool.yourSupply.toFixed(4)} {pool.coin}
                  </div>
                  <div className="text-sm text-gray-500">≈ {formatCurrency(pool.yourSupply * pool.price)} USD</div>
                </td>
                <td className="py-4 text-right">
                  <div className="text-gray-900 font-medium">
                ...
                <td className="py-4 text-right">
                  <div className="flex gap-2 justify-end">
                    <button
                      ...
                      className="px-4 py-2 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-all font-medium border border-primary/20 cursor-pointer"
                    >
                      {type === "lending" ? "Supply" : "Borrow"}
                    </button>
                    <button
                      onClick={() => handleWithdrawClick(pool)}
                      className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all font-medium border border-gray-200 cursor-pointer"
                    >
